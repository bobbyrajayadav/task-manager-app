...
const InProgressContainer = ({ tasks = [], onDropTask, onEditTask, onDeleteTask }) => {
  ...
  return (
    ...
    >
      <div className='flex items-center gap-2'>
        <Dot color="#0055ff" size={40} className="sm:size-[50px]"/>
        <h2 className='font-bold text-sm sm:text-base'> In-Progress ({tasks.length})</h2>
      </div>
