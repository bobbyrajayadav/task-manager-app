...
const CompletedContainer = ({ tasks = [], onDropTask, onEditTask, onDeleteTask }) => {
  ...
  return (
    ...
    >
      <div className='flex items-center gap-2'>
        <Dot color="#00ff2a" size={40} className="sm:size-[50px]"/>
        <h2 className='font-bold text-sm sm:text-base'> Completed ({tasks.length})</h2>
      </div>
